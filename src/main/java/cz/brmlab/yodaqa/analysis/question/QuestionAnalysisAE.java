...
public class QuestionAnalysisAE /* XXX: extends AggregateBuilder ? */ {
	...
	public static AnalysisEngineDescription createEngineDescription() throws ResourceInitializationException {
		...
		/*
		 * XXX: Sorry for the mess below for now. We list all our alternatives
		 * for now, but will clean it up later.
		 */
...
//				OpenNlpParser.PARAM_MODEL_LOCATION, "/home/selman/Software/Git/QA/yodaqa/lib/parser-nl-chunking.bin",
		...
		/*
		 * // just wrong (Who received the Nobel Prize for Physiology and
		 * Medicine in the year 2012?) - everything depends on medicine
		 * builder.add(AnalysisEngineFactory.createEngineDescription(MateParser.
		 * class)); // a bit wrong (Who received the Nobel Prize for Physiology
		 * and Medicine in the year 2012?) - 2012 depends on received
		 * builder.add(AnalysisEngineFactory.createEngineDescription(
		 ...
		 * builder.add(AnalysisEngineFactory.createEngineDescription(
		 * ClearNlpSemanticRoleLabeler.class));
		 */
