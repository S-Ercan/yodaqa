 ...
 *
 * This is an aggregate AE that will run a variety of annotators on the CandidateAnswerCAS, running
 * possibly more detailed linguistic analysis, determining its LAT etc. and correlating the results
 * with the Question view to estimate correctness.
 */
